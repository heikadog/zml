...
Because there's already a form to submit accounts to the list, don't submit them as an issue or pull request; submit them at the link above instead so your response is confidential. Only submit an issue or pull request here if you have a suggestion or fix for this GitHub repo itself.